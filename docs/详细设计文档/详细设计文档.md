...
| CommodityServiceUi        | 提供给其他商品及其分类界面的展示和功能。 |
...
| 接口名称                                     | 服务名       |
| ---------------------------------------- | --------- |
| `commodityblservice.CommodityBlService.add(CommoditySortVo newSort,CommoditySortVo parentSort)` | 提交新分类。    |
| `commodityblservice.CommodityBlService.modify(CommoditySortVo sort)` | 修改分类。     |
| `commodityblservice.CommodityBlService.query(CommoditySortQuerVo commoditySortQueryVo)` | 查询分类信息。   |
| `commodityblservice.CommodityBlService.delete(CommoditySortVo sort)` | 删除分类。     |
| `commodityblservice.CommodityBlService.display();` | 显示所有父类。   |
| `commodityblservice.CommodityBlService.display(CommoditySortVo commoditySort)` | 显示父类下的子类。 |
...
| InventoryBillService           | 负责实现为其他包提供查询获取报损、报溢、报警、赠送单据服务。 |
...
| `logbl.LogBl.log(LogSeverity severity, String content)` | 记录日志。         |
| `commodityblservice.CommdoityService.queryCommodity(CommodityQueryVo commodityQueryVo)` | 查询商品。         |
...
| `commodityblservice.CommodityService.queryCommodity(CommodityQueryVo commodityQueryVo)` | 获取商品。     |
...
| CommoditySerivce.queryCommoditySort | `public CommoditySortVo[] queryCommoditySort(CommoditySortQueryVo commoditySortQueryVo);` | 其他类需要商品分类信息。 | 返回所需分类的持久化对象。 |
