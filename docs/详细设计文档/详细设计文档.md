...
| `inventoryblservice.InventoryCheckBlService.export(String path);` | 导出Excel。  |
...
| `commodityblservice.CommodityInfo.queryCommodity();` | 提供商品。  |
...
| ---------------------------------------- | ------- |
| `clientui.ClientInfoUi.showClientSelectDialog() ` | 选择客户。   |
| `adminui.EmploySelectionInfoUi.showEmployeeSelectDialog()` | 选择操作员。  |
...
| 接口名称                    | 语法                                       | 前置条件        | 后置条件       |
| ----------------------- | ---------------------------------------- | ----------- | ---------- |
| adminui.EmploySelection | `public void showEmployeeSelectDialog (Consumer<List<EmployeeVo>> callback);` | 查询并选择有效的职员。 | 返回职员的详细信息。 |
...
| PromotionManagementUiController | 负责管理促销策略查看和删除界面的展示和功能。     |
| PromotionSelectionUiController  | 负责销售人员选择可用促销策略界面的展示和功能。    |
...
| `promotionblservice.TotalPricePromotionBlService.queryPromotion(PromotionQueryVO query)` | 根据不同的筛选条件查找促销策略。 |
| `promotionblservice.ClientPromotionBlService.delete(ClientPromotionVo promotion)` | 删除单一持久化对象。       |
| `promotionblservice.ComSalePromotionBlService.delete(ClientPromotionVo promotion)` | 删除单一持久化对象。       |
| `promotionblservice.TotalPricePromotionBlService.delete(ClientPromotionVo promotion)` | 删除单一持久化对象。       |
...
| 接口名称                           | 语法                                       | 前置条件             | 后置条件          |
| ------------------------------ | ---------------------------------------- | ---------------- | ------------- |
| promotionui.PromotionSelection | `public void showEmployeeSelectDialog (Consumer<PromotionVoBase> callback,SaleBillVo bill);` | 输入有效的用于继续填写促销策略。 | 初始化传入促销策略的内容。 |
...
| InventoryDetialBillInfo        | 负责实现为其他包提供查询获取报警、报溢、报损单据服务。 |
| InventoryGiftInfo              | 负责实现为其他包提供查询获取赠送单据服务。       |
...
| InventoryCheckBlService.export           | `public ResultMessage export(String path);` | 已经完成库存盘点。   | 导出Excel到指定位置。                            |
...
| 接口名称                                     | 服务名      |
| ---------------------------------------- | -------- |
| `commodityblservice.CommodityInfo.getAllCommodity();` | 得到所有商品。  |
...
| InventoryGiftBlService.queryInventoryGiftBill | `public InventoryGiftVo[] queryInventoryGiftBill(InventoryGiftQueryVo inventoryBillQueryVo);` | 输入合法。         | 查询符合条件的赠送单。                      |
...
| `inventorydataservice.InventoryGiftDataService.activate(BillPo bill) ` | 使单据生效。       |
| `inventorydataservice.InventoryGiftDataService.abandon(BillPo bill)` | 废弃单据。        |
...
| 接口名称                                     | 语法                                       | 前置条件       | 后置条件          |
| ---------------------------------------- | ---------------------------------------- | ---------- | ------------- |
| InventoryGiftInfo.queryInventoryGiftBill | `public InventoryGiftVo[] queryInventoryGiftBill(InventoryGiftQueryVo inventoryBillQueryVo);` | 其他类需要单据信息。 | 返回所需单据的持久化对象。 |

需要的接口

| 接口名称                                     | 服务名               |
| ---------------------------------------- | ----------------- |
| `inventoryBldataservice.InventoryGiftDataService.query(InventoryGiftBillQueryVo inventoryBillQueryVo)` | 根据ID和/或名称模糊化查询单据。 |

**InventoryDetailBillInfo**

提供的接口

| 接口名称                                     | 语法                                       | 前置条件       | 后置条件          |
| ---------------------------------------- | ---------------------------------------- | ---------- | ------------- |
| .InventoryDetailBillInfo.queryInventoryWarningBill | `public InventoryDetailBillVo[] queryInventoryWarningBill(InventoryBillQueryVo inventoryBillQueryVo);` | 其他类需要单据信息。 | 返回所需单据的持久化对象。 |

需要的接口

| 接口名称                                     | 服务名               |
| ---------------------------------------- | ----------------- |
| `inventoryBldataservice.InventoryWarningDataService.query(InventoryBillQueryVo inventoryBillQueryVo)` | 根据ID和/或名称模糊化查询单据。 |
