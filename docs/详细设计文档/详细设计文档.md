...
| `admindataservice.FaceIdRegistrationDataService.register(String employeeId, byte[] image)` | 注册人脸信息。        |
| `admindataservice.FaceIdRegistrationDataService.unregister(String employeeId) ` | 删除人脸信息。        |
| `logbl.LogService.log(LogSeverity severity, String content);` | 记录日志           |
