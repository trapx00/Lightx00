...
| financedataservice.ReceivalBill.getTranscationsByIDs | `public Transcation[] getTranscationsByIDs(String... IDs);` | 用户登录。| 返回Transcation对象集合，若ID为空或者null，返回空数组。|
...
| financedataservice.PaymentBill.getTranscationsByIDs | `public Transcation[] getTranscationsByIDs(String... IDs);` | 用户登录。| 返回Transcation对象集合，若ID为空或者null，返回空数组。|
...
| financedataservice.PaymentBill.getTranscationsByIDs | `public CashBillItem[] getCashBillItemsByIDs(String... IDs);` | 用户登录。| 返回CashBillItem对象集合，若ID为空或者null，返回空数组。|
