...
| 扩展流程    | 5a. 财务人员需要进行**红冲**：<br/>&emsp;1. 财务人员选定一条单据；<br/>&emsp;2. 系统生成一个一模一样的单据并返回等待确认；<br/>&emsp; 3. 财务人员确认；<br/>&emsp;4. 系统入账。<br/>5b. 财务人员需要进行**红冲并复制**：<br/>&emsp;1. 财务人员选定一条单据；<br/>&emsp;2. 系统生成一个一模一样但是把数量取负的单子，并显示给财务人员；<br/>&emsp;3. 财务人员进行修改，并提交；<br/>&emsp;4. 系统把新的单子入账。<br/>5c. 财务人员需要导出报表：<br/>&emsp; 1. 财务人员选中需要导出的报表和信息，并选定导出地址和格式；<br/>&emsp; 2. 系统根据财务人员的要求导出相应报表和信息。 |
| 特殊需求    | 财务人员不能修改和删除已经有的单据。                       |
...
| 优先级     | 高                                        |
| 正常流程    | 1. 财务人员收到消息，进入操作界面；<br/>2. 如果审核通过：<br/>&emsp; 2(1). 系统显示**收款单**以及**所有账户**信息；<br/>&emsp; 2(2). 财务人员根据这些信息，修改**客户的应付/应收数据**，并完成现实银行账户操作，提交；<br/>&emsp; 2(3). 系统处理相关信息。<br/>3. 如果审核不通过：<br/>&emsp; 3(1). 系统显示不通过原因，并撤回 收/付款单。 |
