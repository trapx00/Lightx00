...
| CommoditySortBlService.add               | `public ResultMessage add(CommoditySortVo newSort,CommoditySortVo parentSort);` |
| CommoditySortBlService.modify            | `public ResultMessage modify(CommoditySortVo sort);` |
| CommoditySortBlService.query             | `public CommoditySortVo[] query(CommoditySortQuerVo commoditySortQueryVo);` |
| CommoditySortBlService.delete            | `public ResultMessage delete(CommoditySortVo sort);` |
| CommoditySortBlService.getId             | `public String getId();`                 |
| CommoditySortBlService.queryCommoditySort | `public CommoditySortVo[] queryCommoditySort(CommoditySortQuerVo commoditySortQueryVo);` |
| CommoditySortBlService.getAllCommoditySort | `public CommoditySortVo[] getAllCommoditySort();` |
...
| SaleBillBlService.queryPromotion    | `public PromotionVoBase[] queryPromotion(SaleBillVo); ` | 无。          |             |
...
| 接口名称                                     | 服务名          |
| ---------------------------------------- | ------------ |
| `saleblservice.SaleBillDataService.submit(SaleBillPo saleBill)` | 提交表单。        |
| `draftbl.DraftManagement.saveAsDraft(SaleBillPo saleBill)` | 保存草稿。        |
| `saleblservice.SaleRefundBillDataService.submit(SaleRefundBillPo saleRefundBill)` | 提交表单。        |
