...
public class InventoryCheckDataControllerTest {
    ...
    public void picture() throws Exception {
        ...
        assertEquals(0, inventoryCheckDataService.getInventoryPicture(new InventoryPictureQueryVo(q->q.where().eq("id","PICT-0001-0001").prepare())).length);
        inventoryPictureDao.delete(inventoryPicturePo);
    }
    ...
    public void view() throws Exception {
        ...
        assertEquals(1, inventoryCheckDataService.getInventoryView(new InventoryViewQueryVo(q->q.where().eq("id","VIEW-0001-0001").prepare())).length);
        inventoryViewDao.delete(inventoryViewPo);
    }
